...
/*****************************************************************************
 *
 *  build_update_links_arrays
 *
 *  Reconstruct or reset the boundary links for each colloid as necessary.
 *
 *****************************************************************************/

int build_update_links_arrays(cs_t * cs, colloids_info_t * cinfo, wall_t * wall,
...
/*****************************************************************************
 *
 *  build_count_links_local_arrays
 *
 *  A utility.
 *
 *****************************************************************************/

int build_count_links_local_arrays(colloid_t * colloid, int * nlinks) {
...
/*****************************************************************************
 *
 *  build_count_faces_local_arrays
 *
...
/*****************************************************************************
 *
 *  build_conservation_links_arrays
 *
...
int build_conservation_links_arrays(colloids_info_t * cinfo, field_t * phi, psi_t * psi,
		       const lb_model_t * model) {
...
int build_conservation_psi_links_arrays(colloids_info_t * cinfo, psi_t * psi,
  ...
  for (; colloid != NULL; colloid = colloid->nextall) {
    ...
    build_count_faces_local_arrays(colloid, model, &sa_local, &saf_local);
